...
if(isset($_POST['generate_pdf'])){
    ...
    $html = preg_replace('/<a href="adminhome.php" class="btn btn-danger logout-button">Logout<\/a>/', '', $html);
    ...
    $dompdf->stream('transactions.pdf', array('Attachment' => 1));

    // Update the status of completed laundry to "paid" after generating the PDF
    require_once 'transactions.php'; // Include transactions.php to execute any necessary queries
}
?>
